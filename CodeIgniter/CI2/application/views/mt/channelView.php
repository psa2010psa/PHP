        ...
        <div class="wrapper"> 
          ...
          <div class="sidebar_navigation gradient">
            <ul>
              ...
              <li  data-original-title="渠道" class="active tip-right"> <a href="/mt/entry/channel" class="icos_panel"> <span class="tab_label">渠道</span> <span class="tab_info">CHANNEL</span> </a> </li>
              <li  data-original-title="数据" class="tip-right"> <a href="/mt/entry/dataIndex" class="icos_panel"> <span class="tab_label">数据</span> <span class="tab_info">DATA</span> </a> </li>
                      ...
                      <table width="100%" cellspacing="0" cellpadding="0" class="default_table selectable_table">
                        <thead>
                          <tr>
                            <td></td>
                            <td>
                                <?php if(!$userLimit && !in_array(2, $userLimit)){
                                    }else{?>
                                <a href="http://210.14.139.104:38002/Account/LogOn?ReturnUrl=%2f" target="_blank">渠道更新地址编辑</a>
                                    <?php }?>
                            </td>
                            <td>
                                <?php if(!$userLimit && !in_array(2, $userLimit)){
                                    }else{?>
                                <a href="#" target="_blank">渠道后台入口</a>
                                    <?php }?>
                            </td>
                          </tr>
                        </thead>

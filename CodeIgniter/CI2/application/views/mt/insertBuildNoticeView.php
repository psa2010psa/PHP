      ...
      <div class="wrapper"> 
        ...
        <div class="content_wrapper">
          <div class="contents">
            ...
            <div class="" style="float:left;min-width: 800px;max-width: 900px;height: 25px;margin-bottom:10px;">
            </div>
            ...
            <div class="row-fluid" id="choseNoticeBox" >
              <div class="span6">
                ...
                <button class="btn btn-success" type="button" style="float:right;" onClick="choseServer();" >选区插入</button>
...
function saveQueen(){
	...
	$.ajax({
        url: "/mt/notice/insertBuild",
		type:"POST",
        data: {"idList":eval(hasChoseId),"serverList":eval(serverList)},
        dataType: "json",
        success: function (data) {
            if (data.errorCode !=0 ) {
                alert("输入错误，请刷新后重试！");
                ...
                $(".modal").modal('hide');
                window.location.href = "/mt/notice/noticeList";
            }
        },
